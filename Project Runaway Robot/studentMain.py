...
def estimate_next_pos(measurement, OTHER = None):
    ...
    # save first data
    if not OTHER:
        OTHER = (measurement,0) # x,y measurements, turning radius
    # get angle
    ...
    turning = angle - OTHER[1]
    # create robot
    Traxbot = robot(measurement[0], measurement[1], angle, turning, distance)
    # move the robot
    Traxbot.move(Traxbot.turning, Traxbot.distance)
    # save information for use in the next step
    OTHER = (measurement, turning)
    # final estimate
    xy_estimate = (Traxbot.x, Traxbot.y)
